...
class AddTransaction extends Component {
  constructor(){
    super();
    this.state = {amount: '', description: '', date: '', income: '', expense: '', transactionAddResult: ''};
...
event.preventDefault();
  ...
  render() {
    const isEnabled = this.state.amount.length > 0 && this.state.description.length > 0 && this.state.date.length > 0 
    ...
    return (
      <div>
		...
		<form onSubmit={this.handleSubmit}>
                    <input type="number" className="form-control" placeholder="Amount" value={this.state.amount} onChange={this.handleAmountChange}/>
                    <br/>
                    ...
                    <br />
                    <input type="date" className="form-control" placeholder="Date" value={this.state.date} onChange={this.handleDateChange}/>
                    <br />
                    <label><input type="checkbox" value={this.state.income} onChange={this.handleIncomeChange}/>&nbsp;Income</label><span>&nbsp;</span>
