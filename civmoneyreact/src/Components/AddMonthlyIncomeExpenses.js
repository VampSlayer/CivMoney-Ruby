...
class AddMonthlyIncomeExpenses extends Component {
  constructor(){
    super();
    this.state = {income: '', expenses: '', transactionAddResult: ''};
      ...
      <div>
		...
		<form onSubmit={this.handleSubmit}>
		    <p>Add this month's known fixed income and expenses</p>
                    <input type="number" className="form-control" placeholder="Income" value={this.state.income} onChange={this.handleIncomeChange}/>
                    <br/>
                    <input type="number" className="form-control" placeholder="Expenses" value={this.state.expenses} onChange={this.handleExpenseChange}/>
                    <br />
