          ...
          <div className="row">
			...
			<strong className="text-red">{this.state.error}</strong>
                        <div className="form-group">
                          <input className="form-control" placeholder="Username" name="username" type="text" value={this.state.username} onChange={this.handleUsernameChange}/>
                        </div>
                        <div className="form-group">
                        ...
                        <div className="form-group">
                          <input disabled={!isEnabled} type="submit" value="Login" className="btn btn-lg btn-success btn-block"/>
                        </div>
                      </fieldset>
                    </form>
                    <div className="form-group">
                      <button className="btn btn-lg btn-danger btn-block"><Link className="whiteText" to="/register">Register</Link></button>
                    </div>
                 </div>
            </div>
            </div>
